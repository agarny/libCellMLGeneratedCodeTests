...
def objective_function_2(u, f, data):
    ...
    f[0] = algebraic[1]-algebraic[3]*(states[0]-computed_constants[0])-0.0
...
def objective_function_3(u, f, data):
    ...
    f[0] = externals[0]-algebraic[4]*pow(states[2], 3.0)*states[1]*(states[0]-computed_constants[1])-0.0
...
def objective_function_9(u, f, data):
    ...
    f[0] = algebraic[2]-algebraic[9]*pow(states[3], 4.0)*(states[0]-computed_constants[2])-0.0
